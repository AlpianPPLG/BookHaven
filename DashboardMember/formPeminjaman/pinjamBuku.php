...
<body>
    ...
    <div class="p-4 mt-5">
                ...
                <form action="" method="post">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="id_buku" class="form-control" placeholder="id buku"
                            aria-label="id_buku" aria-describedby="basic-addon1" value="<?= $item["id_buku"]; ?>"
                            readonly>
                    </div>
                    <?php endforeach; ?>
        ...
        <div class="alert alert-danger mt-4" role="alert"><span class="fw-bold">Catatan :</span> Setiap keterlambatan
            pada pengembalian buku akan dikenakan sanksi berupa denda.</div>
